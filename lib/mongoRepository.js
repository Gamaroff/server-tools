...
module.exports = function (type) {
    ...
    self.get = function () {
        ...
        promises.query(obj, data.query || {}, data.sort || {}, data.limit, data.fields || [])
    ...
    self.addToSet = function (data, callback) {
        var obj = new model(type);
        ...
        update.$addToSet[data.field] = data.data;

        obj.update(data.query, update, { safe: true, upsert: true }, function (err, result) {
            callback(err, result);
        });
